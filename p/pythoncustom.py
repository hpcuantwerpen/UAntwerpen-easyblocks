...
class EB_PythonCustom(ConfigureMake):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(EB_PythonCustom, self).__init__(*args, **kwargs)
    ...
    def configure_step(self):
        ...
        super(EB_PythonCustom, self).configure_step()
    ...
    def build_step(self, *args, **kwargs):
        ...
        super(EB_PythonCustom, self).build_step(*args, **kwargs)
    ...
    def install_step(self):
        ...
        super(EB_PythonCustom, self).install_step()
    ...
    def sanity_check_step(self):
        ...
        super(EB_PythonCustom, self).sanity_check_step(custom_paths=custom_paths, custom_commands=custom_commands)

    def make_module_extra(self, *args, **kwargs):
        """Add path to sitecustomize.py to $PYTHONPATH"""
        txt = super(EB_PythonCustom, self).make_module_extra()
