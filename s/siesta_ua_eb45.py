...
class EB_Siesta_UA_EB45(ConfigureMake):
    """
    ...
    def configure_step(self):
        ...
        if loose_ver < LooseVersion('4.1.0.2.2'):
            ...
            super(EB_Siesta_UA_EB45, self).configure_step(cmd_prefix='../Src/')
    ...
    def test_step(self):
        ...
        super(EB_Siesta_UA_EB45, self).test_step()
    ...
    def sanity_check_step(self):
        ...
        super(EB_Siesta_UA_EB45, self).sanity_check_step(custom_paths=custom_paths, custom_commands=custom_commands)
